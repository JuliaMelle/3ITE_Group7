    ...
    <div class="parent">
        ...
        <div class=" mid_card card card_width ">
            <div class="card-body card_width_body text_left">
                ...
                <input class="form-control margin_forms font_bold" type="text" placeholder="FIRST NAME" aria-label="default input example">
                <input class="form-control margin_forms font_bold" type="text" placeholder="LAST NAME" aria-label="default input example">
                <input class="form-control margin_forms font_bold" type="text" placeholder="+63" aria-label="default input example">
            ...
            <div class="button_position">
                <button type="button" class="btn btn-warning  button_size font_bold">LOGIN</button>
                <button type="button" class="btn btn-warning  button_size font_bold register">REGISTER</button>
